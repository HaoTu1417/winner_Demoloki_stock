...
class HomeController extends BaseController
{
            ...
            if ($item != 'stock_VNINDEX' && $item != 'stock_STOCK_INFO') {
                ...
                if ($dataStock != null && $dataStock->lastPrice > 0 && $dataStock->lot > 0) {
                    if ($request->order == 'desc') {
                        if ($dataStock->lastPrice !=null && $dataStock->r!=null && $dataStock->lastPrice >= $dataStock->r) {
    ...
    public function getstock(Request $request)
    {
        ...
        $collectData = collect($open)->where('sym', $data->sym)->first()->o ?? 100;
    ...
    public function customer()
    {
        ...
        Log::info('HomController->cusotomer '.json_encode($this->data));
    ...
    public function cancelOrder(Request $request, $id)
{
    ...
    public function buy(Request $request)
    {
        ...
        //TODO: migration de them truong subaccount_id
        DB::table('historys')->insert([
            'customer_id' => $customerData->id,
            'befores' => $beforeAmount,
